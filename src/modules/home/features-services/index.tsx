...
import { ServiceFooter } from '@/modules/home/features-services/components/service-footer'
import { ServiceHeaderBanner } from '@/modules/home/features-services/components/service-header-banner'
import { ServiceItem } from '@/modules/home/features-services/components/service-item'
import { mockServicesData } from '@/modules/home/features-services/data/mock-services'
...
export const FeaturedServicesSection: React.FC = () => {
  ...
  return (
    <section className='w-full bg-white py-[5rem] xsm:py-[2rem]'>
      <div className='mx-auto w-full max-w-[93rem] px-[2.5rem] xsm:px-[1rem]'>
        <ServiceHeaderBanner />

        {/* ==================== DESKTOP LIST ==================== */}
        <div className='block xsm:hidden mt-[2.5rem] flex-col'>
        ...
        {/* ==================== MOBILE SLIDER ==================== */}
        <div
          className='hidden xsm:block mt-[1rem] select-none'
        ...
        >
          ...
          <div className='mt-[1.25rem] flex items-center justify-between px-[0.25rem]'>
            ...
            <div className='flex items-center gap-[0.5rem]'>
              <button
                ...
                className='flex h-[2.25rem] w-[2.25rem] items-center justify-center rounded-full border border-[#0089cf] text-[#0089cf] transition-colors active:bg-[#0089cf] active:text-white'
              >
